...
// --- UMD export. In the browser/worker, W/B/Chess resolve lexically from
// chess.js (same global scope). Under Node `require`, module scopes are
// isolated, so surface chess.js's globals on globalThis before any search runs
// (LorFish references bare W/B; callers do `new Chess`). ---
if (typeof module !== 'undefined' && module.exports) {
  const chessModule = require('./chess.js');
  globalThis.W = chessModule.W;
  globalThis.B = chessModule.B;
  globalThis.Chess = chessModule.Chess;
  module.exports = { LorFish };
}
